...
external_links = dbc.Alert(
    [
        "Made by ",
        html.A("Joiner David", href="https://linkedin.com/in/joiner-cantillo", className="alert-link"),
        " ✌️",
        html.Hr(),
        "Feature requests and bug reports etc. are welcome at the ",
        html.A(
            "source repository",
            href="https://github.com/Timon0219",
...
app_layout = dbc.Container(
    [
        html.H1("Formula 1 Racing Challenge: 2024 Strategy Analysis"),
        session_picker_row,
